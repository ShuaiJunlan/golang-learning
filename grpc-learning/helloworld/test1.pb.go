...
func init() {
	proto.RegisterType((*HelloRequest)(nil), "test1.HelloRequest")
	proto.RegisterType((*HelloReply)(nil), "test1.HelloReply")
}
...
var fileDescriptor_a038b2eef6c1cfff = []byte{
	...
	0x31, 0xd4, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x05, 0x73, 0x94, 0x94, 0xb8, 0x78, 0x3c,
	...
	0x22, 0x18, 0xd7, 0xa8, 0x8a, 0x8b, 0xdd, 0xbd, 0x28, 0x35, 0xb5, 0x24, 0xb5, 0x48, 0xc8, 0x84,
	0x8b, 0x23, 0x38, 0xb1, 0x12, 0xac, 0x4b, 0x48, 0x58, 0x0f, 0x62, 0x2f, 0xb2, 0x3d, 0x52, 0x82,
	0xa8, 0x82, 0x05, 0x39, 0x95, 0x4a, 0x0c, 0x42, 0x96, 0x5c, 0xbc, 0x30, 0x5d, 0x8e, 0xe9, 0x89,
	0x99, 0x79, 0xc4, 0x6b, 0x4d, 0x62, 0x03, 0xfb, 0xca, 0x18, 0x10, 0x00, 0x00, 0xff, 0xff, 0x63,
	0x74, 0xdc, 0x46, 0xe4, 0x00, 0x00, 0x00,
}
...
func (c *greeterClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/test1.Greeter/SayHello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *greeterClient) SayHelloAgain(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloReply, error) {
	out := new(HelloReply)
	err := c.cc.Invoke(ctx, "/test1.Greeter/SayHelloAgain", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Greeter_SayHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/test1.Greeter/SayHello",
	}
...
func _Greeter_SayHelloAgain_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/test1.Greeter/SayHelloAgain",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
